...
INFO     Using /root/.cache/ansible-lint/ec6005/roles/jekker600.kibana_role symlink to current repository in order to enable Ansible to find the role using its expected full name.
...
```
6.
- [https://github.com/Jekker600/kibana-role/tree/1.0.2](https://github.com/Jekker600/kibana-role/tree/1.0.2)
- [https://github.com/Jekker600/filebeat-role/tree/2.0.0](https://github.com/Jekker600/filebeat-role/tree/2.0.0) 
## Tox
...
__________________________________________________________ summary ___________________________________________________________
  ...
  py36-ansible211: commands succeeded
  py37-ansible28: commands succeeded
  py37-ansible29: commands succeeded
  py37-ansible210: commands succeeded
  py37-ansible211: commands succeeded
  py38-ansible28: commands succeeded
  py38-ansible29: commands succeeded
  ...
  ```
  8.
 - [https://github.com/Jekker600/kibana-role/tree/2.0.0](https://github.com/Jekker600/kibana-role/tree/2.0.0)
 - [https://github.com/Jekker600/filebeat-role/tree/2.1.0/filebeat-role](https://github.com/Jekker600/filebeat-role/tree/2.1.0/filebeat-role)
